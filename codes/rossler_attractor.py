...
ax.set_title('罗斯勒吸引子', fontsize=16, pad=20)
...
def progress_callback(current_frame, total_frames):
    ...
    if current_frame == total_frames - 1:
        print("\nGIF动画已保存完成")
ani.save('rossler_attractor.gif', writer='pillow', fps=480, dpi=60,  # fps从240增加到480
